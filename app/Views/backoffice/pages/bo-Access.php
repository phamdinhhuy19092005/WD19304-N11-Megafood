<div class="k-content">
        ...
        <div class="k-content_head">
            <div class="k-content_head-main">
                <h3 class="k-content_head-title">Quyền truy cập</h3>

                <div class="k-content__head-breadcrumbs">
                    <a href="" class="k-content__head-breadcrumb-home"><i class="fa-solid fa-house"></i></a>
                    <a href="" class="k-content__head-breadcrumb-link"><i class="fa-solid fa-circle"></i>Quyền truy cập</a>
                </div>
            </div>
        </div>
            ...
            <div class="k-portlet">
                <div class="k-portlet_head">
                    <div class="k-portlet_head-label">
                        <h3 class="k-portlet_head-title">Danh sách quyền quản trị</h3>
                    </div>
                    <div class="k-portlet_head-toolbar">
                        <div class="k-portlet_head-toolbar-wrapper">
                            <a class="btn-brand"><i class="fa-solid fa-plus"></i>Tạo quyền quản trị </a>
                        </div>
                    </div>
                </div>
            </div>
