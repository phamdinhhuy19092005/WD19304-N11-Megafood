            ...
            <div class="details_product">
                    ...
                    <div class="product_detailas_left">
                        <div class="product_img_block">
                            <div class="gallery_top">
                                <img src="https://bizweb.dktcdn.net/100/510/571/products/0003952-crispy-chicken-with-sg-s.png?v=1708679420060"
                                    alt="">
                            </div>
                            <div class="gallery_bottom">
                                <ul class="list_gallery_bottom dis_flex">
                                    ...
                                    <li class="item_gallery_border selected">
                                        <img src="https://bizweb.dktcdn.net/thumb/medium/100/510/571/products/0003952-crispy-chicken-with-sg-s.png?v=1708679420060"
                                            alt="">
                                    </li>
                                    <!-- Khi chưa có border -->
                                    <li class="item_gallery">
                                        <img src="https://bizweb.dktcdn.net/thumb/medium/100/510/571/products/0003953-crispy-chicken-with-sg-s.png?v=1708679420060"
                                            alt="">
                                    </li>

                                    <li class="item_gallery">
                                        <img src="https://bizweb.dktcdn.net/thumb/medium/100/510/571/products/0003954-crispy-chicken-with-sg-s.png?v=1708679420060"
                                            alt="">
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="product_relate">
                        ...
                        <!-- product -->
                        <div class="product_relate_swiper">
                            <ul class="owl-carousel owl-theme list_prd_relate">

                                <!-- Product Item 1 -->
                                <li class="item">
                                    <div class="product_item">
                                        <a href="#" class="product_thumb">
                                            <img src="https://bizweb.dktcdn.net/thumb/large/100/510/571/products/0003951-crispy-chicken-with-k-sa.png?v=1708679419150"
                                                alt="Product 1">
                                        </a>
                                        <a href="#" class="setWishlist" title="Thêm vào danh sách yêu thích">
                                            <i class="fa-regular fa-heart"></i>
                                        </a>
                                    </div>
                                    <div class="product_info">
                                        <span class="product_name">
                                            <a href="#">Gà Giòn Xốt Hàn - Truyền Thống</a>
                                        </span>
                                        <div class="product_content">
                                            <span>
                                                Gà tẩm bột chiên giòn rụm phủ lớp xốt (có chút vị cay rất nhẹ) đặc
                                                trưng theo kiểu truyền thống.
                                            </span>
                                            <a href="#">Xem thêm</a>
                                        </div>
                                        <div class="group_form">
                                            <div class="price-box">
                                                <span>Giá chỉ từ</span> 429.000₫
                                            </div>
                                            <a title="Thêm" href="#">Thêm</a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="item">
                                    <div class="product_item">
                                        <a href="#" class="product_thumb">
                                            <img src="https://bizweb.dktcdn.net/thumb/large/100/510/571/products/0003950-crispy-chicken-with-k-sa.png?v=1708679418013"
                                                alt="Product 2">
                                        </a>
                                        <a href="#" class="setWishlist" title="Thêm vào danh sách yêu thích">
                                            <i class="fa-regular fa-heart"></i>
                ...
                <div class="row">
                    ...
                    <div class="product_relate">
                        <h3 class="title">
                            <a class="title-name" href="#" title="Món ăn liên quan">Món ăn đã xem
                            </a>
                        </h3>
                        <!-- product -->
                        <div class="product_relate_swiper">
                    ...
                    <div class="block-blog">
                        <a class="baner_detail" href="#">
                            <img src="https://bizweb.dktcdn.net/100/510/571/themes/941527/assets/banner-pro.jpg?1727255430829" alt=""></a>
                    </div>
                </div>
            </div>
    </section>
